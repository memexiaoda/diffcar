...
//			}
			...
			if(control_style == "manual")
			{
				...
				if(/*high_laser_stop_state == 1 || low_laser_stop_state == 1 || ultrasonic_stop_state == 1|| */ObstacleWarning != 0 )
				{
					//停车
...
//				//如果有障碍物开始计时
//				if(_equipmentInfo.ObstacleWarning != 0 /* && control_style == "auto"|| _equipmentInfo.FP_Alarm != 0x00*/)
//				{
//					if(!bestart_record)
//					{
//						bestart_record = true;
